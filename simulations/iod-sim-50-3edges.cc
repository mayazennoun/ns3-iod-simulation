...
NS_LOG_COMPONENT_DEFINE("IoDSim50_3Edges");
...
int main(int argc, char *argv[])
{
    ...
    // ===== NOEUDS =====
    NodeContainer drones1; drones1.Create(17);
    NodeContainer drones2; drones2.Create(17);
    NodeContainer drones3; drones3.Create(16);
    ...
    // ===== MOBILITE =====
    auto installMobility = [](NodeContainer& nodes,
    ...
    monitor->SerializeToXmlFile("iod-results-50-3edges.xml", true, true);
    ...
    NS_LOG_UNCOND("\n========== RESULTATS - 50 DRONES 3 EDGES ==========");
    NS_LOG_UNCOND("Architecture : 3 Edges (17+17+16 drones par Edge)");
